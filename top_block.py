...
# Title: Top Block
# Generated: Fri Aug  2 07:09:23 2019
##################################################
...
class top_block(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.menu.addTab(self.menu_widget_0, 'P1')
        ...
        self.menu.addTab(self.menu_widget_1, 'P2')
        ...
        self.menu.addTab(self.menu_widget_2, 'P3 a)')
        ...
        self.menu.addTab(self.menu_widget_3, 'P3 b)')
        ...
        self.menu.addTab(self.menu_widget_4, 'P3 c)')
        ...
        self.menu_grid_layout_4.addWidget(self.b_PSD_0_0_0, 1, 0, 1, 1)
        for r in range(1, 2):
        ...
        self.menu_grid_layout_2.addWidget(self.b_Eye_Diagram_simple_0, 0, 0, 1, 1)
        for r in range(0, 1):
